    ...
    <section class="home slider" id="home"> 
            ...
            <!-- video -->
             <div class="home-video">
                <div id="block" style="width: 100%; height: 100%;" data-vide-bg="video/ocean" data-vide-options="position: 0% 50%"></div>
             </div>
                    ...
                    <form class="contact-form top_60" method="POST" action="mail.php">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <button id="con_submit" class="sitebtn top_30" type="submit">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
 $(document).ready(function () {
   $('#block').vide({
      'mp4': 'http://ismailogluhali.com/video/ocean.mp4',
      'webm': 'http://ismailogluhali.com/video/ocean.webm',
      'ogv': 'http://ismailogluhali.com/video/ocean.ogv',
     'poster': 'video/ocean',
    });
 });
 </script>
